...
<form:form method="POST" commandName="particularsOfExpenditure">
	<table>
		<tr>
			...
			<td><form:input path="personalFoodExpense"></form:input></td>
		</tr>

		<tr>
			<td>2. Tax paid including deduction at source
	 of the last year :</td>
			<td><form:input path="taxPaidLastYear"></form:input></td>
		</tr>

		<tr>
			<td>3. Accommodation expenses :</td>
			<td><form:input path="accommodationExpense"></form:input></td>
		</tr>

		<tr>
			<td>4. Transport expenses:</td>
			<td><form:input path="transportExpense"></form:input></td>
		</tr>

		<tr>
			<td>5. Gas Bill for residence:</td>
			<td><form:input path="gasBill"></form:input></td>
		</tr>

		<tr>
			<td>6. Electricity Bill for residence:</td>
			<td><form:input path="electricityBill" /></td>
		</tr>

		<tr>
			<td>7. Wasa Bill for residence:</td>
			<td><form:input path="wasaBill" /></td>
		</tr>

		<tr>
			<td>8. Education expenses for children:</td>
			<td><form:input path="educationExpense" /></td>
			
		</tr>

		<tr>
			<td>9. Telephone Bill for residence:</td>
			<td><form:input path="telephoneBill" /></td>
		</tr>

		<tr>
			<td>10.Personal expenses for Foreign travel:</td>
			<td><form:input path="foreignTravelExpense" /></td>
		</tr>

		<tr>
			<td>   Festival and other special expenses, if any:           </td>
			<td><form:input path="festivalExpense"/></td>
		</tr>
		<tr>
