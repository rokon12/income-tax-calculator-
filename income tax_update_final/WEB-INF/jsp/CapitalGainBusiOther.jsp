...
<!-- end #sidebar1 --></div>
<div id="mainContent">
<h2>Capital Gains, Income From Other Source & Foreign Income</h2>

<form:form method="POST" commandName="capitalGainBusiOther">
	<table>
		<tr>
			<td><form:form>1. Captal Gain: </form:form></td>
			<td><form:input path="capital_gain" /></td>
		</tr>

		<tr>
			<td>2. Foreign Income:</td>
			<td><form:input path="foreign_income"></form:input></td>
		</tr>

		<tr>
			<td>3. Income from other sources:</td>
			<td><form:input path="other_source"></form:input></td>
		</tr>
