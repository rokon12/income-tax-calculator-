...
<div id="mainContent">
<h2>Security</h2>
<form:form method="POST" commandName="security">
	<table>
		<tr>
			<td> 1. Interest on Bond: </td>
			<td> <form:input path="interest_on_bond"></form:input></td>
		</tr>	
		<tr>
			<td>2. Interest on Debenture/Securities</td>
			<td> <form:input path="interest_on_deben"></form:input></td>
		</tr>
