...
<div id="container">
  <div id="header">
<h1><img src="image/itaxBan.jpg" width="100%" height="142" alt="itaxLogo"></h1>  <!-- end #header --></div>
	...
	<table>
		...
		<tr>
			...
			<td><form:radiobutton path="gender" value="Female"
				label="Female" /> <form:radiobutton path="gender" value="Male"
				label="Male" /></td>
		...
		<tr>
			...
			<td><form:errors path="zip_code" cssClass="error"></form:errors>
			</td>
		</tr>
